  ...
  if (!data?.hostname) {
    ...
    return (
      <>
        <TitleContent />
        <Alert type="info">
          You must connect your {mediaServerName} account to continue
          configuring a {mediaServerName}
          Media Server.
        </Alert>
        <div className="mx-auto mt-8 max-w-xl">
          {/* TODO Jellyfin setup server form */}
          <JellyfinLogin revalidate={revalidate} initial />
        </div>
      </>
    );
  }
